...
\hypersetup{
  pdftitle={The role of cognateness in recognition of spoken words in a foreign language},
...
English for the first time and encounters the word /\textipa{"dO:}/
(\emph{door}). Their knowledge of the phonological form in their native
language is of little help: /\textipa{"pweR.ta}/ and /\textipa{"dO:}/ do
...
(\citeproc{ref-hall2002automatic}{Hall, 2002};
\citeproc{ref-otwinowska2019more}{Otwinowska \& Szewczyk, 2019}). This
...
reported for comprehension (\citeproc{ref-dijkstra2010cross}{Dijkstra et
al., 2010}; \citeproc{ref-midgley2011effects}{Midgley et al., 2011};
...
situations (\citeproc{ref-lecumberri2010non}{Lecumberri et al., 2010};
\citeproc{ref-takata1990english}{Takata \& Nábělek, 1990}). One of
...
time. This listener may encounter the word /\textipa{"pOKt}/
...
(Spanish) phonemes /\textipa{R}/ and /o/. A perceptual assimilation
...
goodness-of-fit (\citeproc{ref-best1988examination}{Best et al., 1988},
\citeproc{ref-best2001discrimination}{2001}). Although phonetic mismatch
between the non-native word and its translation can have a noticeable
toll on comprehension Cutler et al.
(\citeproc{ref-cutler2004patterns}{2004}), the Spanish monolingual may
...
neighbourhoods (\citeproc{ref-dufour2003lexical}{Dufour \& Peereman,
2003}; \citeproc{ref-goldinger1989priming}{Goldinger et al., 1989};
\citeproc{ref-hamburger1996phonological}{Hamburger \& Slowiaczek, 1996};
\citeproc{ref-luce1990similarity}{Luce et al., 1990};
...
\citeproc{ref-best2001discrimination}{2001}) was used to explain how
...
(\citeproc{ref-otwinowska2019more}{2019}) reported that false friends
...
\bibitem[\citeproctext]{ref-hall2002automatic}
