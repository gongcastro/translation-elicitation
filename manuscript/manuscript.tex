...
\citeproc{ref-peperkamp2008perceptual}{Peperkamp et al., 2008}). The
...
e.g., \citeproc{ref-luce1998recognizing}{Luce \& Pisoni, 1998};
\citeproc{ref-vitevitch2006clustering}{M. Vitevitch, 2006};
\citeproc{ref-vitevitch1998words}{Vitevitch \& Luce, 1998}). In this
...
word /\textipa{"pINgUIn}/ (\emph{pinguin}), which sounds similar to its
...
the \texttt{stringdist} R package (\citeproc{ref-van2014stringdist}{van
der Loo, 2014}). The Levenshtein distance computes the edit distance
...
(\citeproc{ref-schad2020capitalize}{Schad et al., 2020}).
...
participants' prior knowledge abbout form-meaning mappings, we excluded
