...
(\citeproc{ref-gasparov2006semen}{Gasparov, 2006}). This phenomenon
...
(\textipa{/ju: n@U mi:}/) in English, Japanese-native listeners tend to
understand \emph{yunomi} (/\textipa{jUnomi}/), which is a type of
...
\toprule
Translation & X-SAMPA & Accuracy (\%) & SE \\ \midrule %% TinyTableHeader
...
\citeproc{ref-efimova2018homophonic}{Efimova et al., 2018}). The most
...
studied subject (e.g., \citeproc{ref-best1988examination}{Best et al.,
1988}; \citeproc{ref-miyawaki1975effect}{Miyawaki et al., 1975};
\citeproc{ref-pallier2001influence}{Pallier et al., 2001};
\citeproc{ref-van2015learning}{Van Leussen \& Escudero, 2015};
\citeproc{ref-weber2004lexical}{Weber \& Cutler, 2004}; see
\citeproc{ref-baese2020perception}{Baese-Berk et al., 2020} for review).
...
\citeproc{ref-dijkstra2019multilink}{Dijkstra et al., 2019};
\citeproc{ref-dijkstra2002architecture}{Dijkstra \& Van Heuven, 2002};
e.g., \citeproc{ref-kroll1994category}{Kroll \& Stewart, 1994}). The
...
phonological forms (see \citeproc{ref-floccia2018introduction}{Floccia
et al., 2018} for a similar approach). Using this measure, we found that
...
\bibitem[\citeproctext]{ref-baese2020perception}
...
\bibitem[\citeproctext]{ref-dijkstra2019multilink}
...
\bibitem[\citeproctext]{ref-miyawaki1975effect}
...
\bibitem[\citeproctext]{ref-pallier2001influence}
...
\bibitem[\citeproctext]{ref-van2015learning}
