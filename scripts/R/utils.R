...
# text input responses are messy: we need to homogenise them
clean_input_text <- function(x) {
    {{ x }} %>% 
        str_to_sentence() %>%
        str_replace("Lshift|space|minus", "") %>%
...
>>>>>>> c92465ffee5b01a15c56bc645bd58fd50fe89122:R/utils.R
