...
get_model_fits <- function(
    ...
    fit_0 <- brm(
        ...
        save_model = here("scripts", "stan", "fit_responses_0.stan"),
    ...
    fit_1 <- brm(
        ...
        backend = "cmdstanr", # faster compilation times
        seed = seed, # for reproducibility
        save_model = here("scripts", "stan", "fit_responses_1.stan"),
    ...
    fit_2 <- brm(
        ...
        backend = "cmdstanr", # faster compilation times
        seed = seed, # for reproducibility
        save_model = here("scripts", "stan", "fit_responses_2.stan"),
    ...
    fit_3 <- brm(
        ...
        backend = "cmdstanr", # faster compilation times
        seed = seed, # for reproducibility
        save_model = here("scripts", "stan", "fit_responses_3.stan"),
    ...
    fit_4 <- brm(
        ...
        backend = "cmdstanr", # faster compilation times
        seed = seed, # for reproducibility
        save_model = here("scripts", "stan", "fit_responses_4.stan"),
    ...
    fit_5 <- brm(
        ...
        backend = "cmdstanr", # faster compilation times
        seed = seed, # for reproducibility
        save_model = here("scripts", "stan", "fit_responses_5.stan"),
    ...
    fit_6 <- brm(
        ...
        seed = seed, # for reproducibility
        save_model = here("scripts", "stan", "fit_responses_6.stan"),
