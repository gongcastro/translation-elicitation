...
Participants in the ENG-SPA listened to `r nrow(trials[trials$group=="ENG-SPA",])` Spanish words, and participants in the ENG-CAT and the SPA-CAT groups listened to `nrow(trials[trials$group=="ENG-CAT",]) trials`. Five trials in each condition were practice trials and were excluded from analyses.
