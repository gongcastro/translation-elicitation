...
function block_welcomeRoutineBegin(trials) {
  return function () {
    ...
    block_welcomeComponents.forEach( function(thisComponent) {
...
function block_trialRoutineBegin(trials) {
  return function () {
    ...
    block_trialComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function block_farewellRoutineBegin(trials) {
  return function () {
    ...
    block_farewellComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
