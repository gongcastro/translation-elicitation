...
model {
  ...
  if (!prior_only) {
    ...
    for (n in 1:N) {
      ...
      mu[n] += r_1_1[J_1[n]] * Z_1_1[n] + r_1_2[J_1[n]] * Z_1_2[n] + r_1_3[J_1[n]] * Z_1_3[n] + r_1_4[J_1[n]] * Z_1_4[n] + r_1_5[J_1[n]] * Z_1_5[n] + r_2_1[J_2[n]] * Z_2_1[n] + r_2_2[J_2[n]] * Z_2_2[n];
    }
...
generated quantities {
  ...
  real prior_cor_2 = lkj_corr_rng(M_2,5)[1, 2];
